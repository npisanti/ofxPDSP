...
void ofApp::setup(){
    ...
    engine.sequencer.sections[0].label(0, "masterplan" );
    engine.sequencer.sections[0].resizeCells(1);
    
    engine.sequencer.sections[0].sequence(0).setLength( 1.0 / 8.0);
