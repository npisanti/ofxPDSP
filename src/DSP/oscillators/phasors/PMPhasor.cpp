...
pdsp::Patchable& pdsp::PMPhasor::in_pm(){
    return in("pm");
}

pdsp::Patchable& pdsp::PMPhasor::in_sync(){
    return in("sync");
}

pdsp::Patchable& pdsp::PMPhasor::out_phase(){
    return out("phase");
}

pdsp::Patchable& pdsp::PMPhasor::out_inc(){
    return out("inc");
}

pdsp::Patchable& pdsp::PMPhasor::out_sync(){
    return out("sync");
}
