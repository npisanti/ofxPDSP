...
#ifndef OFX_SIMDFLOATS_MATHFUN_NEON_H_INCLUDED
#define OFX_SIMDFLOATS_MATHFUN_NEON_H_INCLUDED
...
//#define c_mathfun_neon_ln2 0.69314718055994530942
#define c_mathfun_neon_ln2 M_LN2
    
    inline_f f128 m_pow2(f128 x){
        f128 expvalue = vmulq_f32(x, vdupq_n_f32(c_mathfun_neon_ln2));  //_mm_mul_ps(x, *(v4sf*)_ps_ln2);
...
#define c_cephes_FOPI 1.27323954473516 // 4 / M_PI
    ...
    /* evaluation of 4 sines & cosines at once.
     ...
     sincos_ps..
     */
    inline_f void m_sincos(f128 x, f128* ysin, f128* ycos) { // any x
    ...
    inline_f f128 m_sin(f128 x) {
        v4sf ysin, ycos; 
        m_sincos(x, &ysin, &ycos);
        return ysin;
    }
    
    inline_f f128 m_cos(f128 x) {
        v4sf ysin, ycos; 
        m_sincos(x, &ysin, &ycos);
        return ycos;
    }
    ...
    inline_f f128 m_tan(f128 x) {
        ...
        cosx = m_rcp(cosx); //custom rcp has higher precision as high as SSE2 _mm_rcp_ps
        return vmulq_f32(sinx, cosx);
    }
...
#endif  // OFX_SIMDFLOATS_MATHFUN_NEON_H_INCLUDED
