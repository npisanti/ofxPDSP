...
Feedfordward stereo compressor with peak-based detection, settable attack, release, threshold, ratio and knee. There is also a method for link the signal detection of the stereo channels, by default they are linked.
*/       
