...
#ifndef PDSP_MODULE_AAHIGHSHELFEQ_H_INCLUDED
#define PDSP_MODULE_AAHIGHSHELFEQ_H_INCLUDED
...
namespace pdsp{
    ...
    /*!
    @brief 2x Oversampled High Shelf Equalizer. Multichannel.
    */  
    
class AAHighShelfEQ : public Patchable {
...
public:
    AAHighShelfEQ(){ patch(); };
    AAHighShelfEQ(const AAHighShelfEQ& other){ patch(); };
    AAHighShelfEQ& operator=(const AAHighShelfEQ& other){ return *this; };
    ~AAHighShelfEQ(){ channels(0); }
...
#endif // PDSP_MODULE_AAHIGHSHELFEQ_H_INCLUDED
