...
SampleBufferPlotter::SampleBufferPlotter(){
...
void SampleBufferPlotter::setWaveform(pdsp::SampleBuffer& sampleBuffer, int channel, ofColor color, int width, int height){
...
void SampleBufferPlotter::draw(int x, int y){
    waveformCanvas.draw(x, y);
}

void SampleBufferPlotter::draw(int x, int y, int w, int h){
    waveformCanvas.draw(x, y, w, h);
}

const ofFbo& SampleBufferPlotter::getFbo(){
