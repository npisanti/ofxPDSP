...
/*!
@brief Two pdsp::Amp with the mod controlled in decibel by a ofxPDSPValue converted from, packed together.
...
class ofxPDSPStereoFader : public pdsp::Patchable {
    
public:
    ofxPDSPStereoFader();
    ofxPDSPStereoFader(const ofxPDSPStereoFader & other);
    ofxPDSPStereoFader& operator=(const ofxPDSPStereoFader & other);
